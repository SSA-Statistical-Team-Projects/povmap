...
#' @seealso \code{\link{povmapObject}}, \code{\link[nlme]{lme}},
#' \code{\link{estimators.povmap}},  \code{\link{plot.povmap}},
#' \code{\link{povmap_summaries}}
#' @examples
#' \donttest{
...
ebp <- function(fixed,
  ...
  if (L==0 && is.null(indicators)) {
    ...
    indicators <- c("Mean","Head_Count","Poverty_Gap","Quantiles")
  }
